...
variable "notes" {
  ...
  type        = string
  default     = "Generated by Terraform. Managed by Release and Test Management."
  nullable    = true
}
...
variable "environment" {
  description = "This variable specifies the current environment. Must be one of [dev],[test] or [prod]"
  type        = string
  default     = ""
  nullable    = false
}
