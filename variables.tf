...
variable "optional_claims" {
  description = <<EOT
  (Optional) A collection of optional_claims blocks as documented below:
  [id_token] (Optional) A collection of id_token blocks as documented below.
  [access_token] (Optional) A collection of access_token blocks as documented below.
  [saml2_token] (Optional) A collection of saml2_token blocks as documented below.
  EOT
  type = list(
    object({
      id_token = list(
